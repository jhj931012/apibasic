...
public class Apicontroller3 {
    ...
    public List<Employee> empList() {
        return List.of(
                new Employee("홍길동","영업부",LocalDate.of(2019,12,2))
                ,new Employee("박영희","구매부",LocalDate.of(2019,3,5))
                ,new Employee("김수호","개발부",LocalDate.of(2019,4,23))
        );
    }
