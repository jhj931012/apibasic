...
//        });
    ...
    @Test
    @DisplayName("쿼리메서드를 사용하여 여성회원만 조회")
    ...
    @Test
    @DisplayName("쿼리메서드를 사용하여 계정명이 abc4321이면서 남성 회원만 조회해야 한다.")
    ...
    @Test
    @DisplayName("쿼리메서드를 사용하여 이름에 '박'이 포함된 회원만 조회")
    ...
    @Test
    @DisplayName("JPQL을 사용하여 이름에 '박'이 포함된 회원만 조회")
    void jpqlTest3() {
        //given
        String nickName = "박";
